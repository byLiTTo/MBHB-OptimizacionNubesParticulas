...
public class PSO_Rosen {
	...
	public PSO_Rosen(int semilla) {
		this(10, 0.01, semilla);
	}

	public PSO_Rosen(int aves, double maxV, int semilla) {
		this.numAves = aves;
	...
	public static double fitness(Vector x) {
		return 1 / (Rosenbrock.aplica(x) + 1);
	}
	...
	private double error(Vector position) {
		...
		// Sabemos que el minimo global para la funcion Rosenbrock en el (1,1).
